        ...
        <div class="row justify-content-center">
            <div class="col-lg-8">
                <div id="product-container" class="owl-carousel"><!-- carousel -->
                    <div class="card bg-dark">
                        <img src="assets/images/1.png" class="card-img-top img-fluid" alt="...">
                        <div class="card-body">
                            <a href="#" class="text-decoration-none">Antony (2018) Tamil DVDRip 480P 720P x264</a>
            ...
            <div class="col-lg-4 p-4" id="letest-movie">
                ...
                <div class="row justify-content-center align-items-center mt-4">
                    <div class="col-12">
                        <img src="assets/images/h1.png" class="card-img-top m-2" alt="..." style="width: 4rem;">
                        <p class="m-2"><a href="#" class="text1">Some quick example text to build on.</a> <br>
                            <span class="text2">2018</span>
                        </p>
                    </div>
                    <div class="col-12">
                        <img src="assets/images/h1.png" class="card-img-top m-2" alt="..." style="width: 4rem;">
